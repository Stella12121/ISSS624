...
In this hands-on exercise, we will learn how to compute spatial weights using R. After finishing the whole concepts, we will be able to:
...
### **1.3.1 Import shapefile**

The code chunk below uses [*st_read()*](https://r-spatial.github.io/sf/reference/st_read.html) of **sf** package to import Hunan shapefile into R. The imported shapefile will be **simple features** Object of **sf**.

```{r}
hunan <- sf::st_read(dsn = "data/geospatial", 
                 layer = "Hunan")
```

### **1.3.2 Import csv file**
...
### **1.5.1 Computing (QUEEN) contiguity based neighbors**

The code chunk below is used to compute Queen contiguity weight matrix.

```{r}
wm_q <- spdep::poly2nb(hunan, queen=TRUE)
summary(wm_q)
```

> Note: what is queen method?
>
> all the eight cells are defined as the neighbors of the central cell.
>
> ![](images/queen.png){fig-align="center" width="190"}
...
The summary report above shows that there are 88 area units in Hunan. The most connect area unit has 10 neighbors. There are two area units with only one heighbour.

> Note: what is rook method?
>
> only those cells with shared boundary can be defined as neighbors.
>
> ![](images/rook.png){fig-align="center" width="190"}
...
#### 1.5.3.1 Plotting Queen contiguity based neighbors map
...
#### 1.5.3.3 Plotting both Queen and Rook contiguity based neighbors maps
...
## **1.6 Computing distance based neighbors**
