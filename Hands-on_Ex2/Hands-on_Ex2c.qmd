...
### **1.2.3 Setting the Analytical Toolls**

Before we get started, we need to ensure that **spdep**, **sf**, **tmap** and **tidyverse** packages of R are currently installed in wer R.
...
### **1.5.1 Compute Moran\'s I correlogram**
...
## **1.6 Cluster and Outlier Analysis**
...
### **1.6.1 Computing local Moran\'s I**
...
#### 1.6.1.1 Mapping the local Moran\'s I
...
#### 1.6.1.2 Mapping local Moran\'s I values
...
#### 1.6.1.3 Mapping local Moran\'s I p-values
...
#### 1.6.1.4 Mapping both local Moran\'s I values and p-values
...
## **1.7 Creating a LISA Cluster Map**

The LISA Cluster Map shows the significant locations color coded by type of spatial autocorrelation. The first step before we can generate the LISA cluster map is to plot the Moran scatterplot.

### **1.7.1 Plotting Moran scatterplot**
...
### **1.7.2 Plotting Moran scatterplot with standardised variable**
...
### **1.7.3 Preparing LISA map classes**
...
## **1.8 Hot Spot and Cold Spot Area Analysis**

Beside detecting cluster and outliers, localised spatial statistics can be also used to detect hot spot and/or cold spot areas.

The term \'hot spot\' has been used generically across disciplines to describe a region or value that is higher relative to its surroundings (Lepers et al 2005, Aben et al 2012, Isobe et al 2015).

### **1.8.1 Getis and Ord\'s G-Statistics**
...
### **1.8.2 Deriving distance-based weight matrix**
...
#### 1.8.2.2 Determine the cut-off distance
...
#### 1.8.2.3 Computing fixed distance weight matrix
...
### **1.8.3 Computing adaptive distance weight matrix**
...
## **1.9 Computing Gi statistics**

### **1.9.1 Gi statistics using fixed distance**
...
### **1.9.2 Mapping Gi values with fixed distance weights**
...
### **1.9.3 Gi statistics using adaptive distance**
...
### **1.9.4 Mapping Gi values with adaptive distance weights**
